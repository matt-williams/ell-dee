...
//     "}",
     ...
     "  lowp vec3 voxelPosition = floor(nearPosition + 0.5 * absFaceNormal * signRayDirection);",
...
//     "    highp float rayToMidVoxelLength = dot(rayToMidVoxelPosition, rayDirection);",
     "    voxelColor = texture2D(voxelMap, (voxelToTexelMatrix * vec4(voxelPosition, 1)).xy);",
//     "    lowp vec3 surfaceVector = floatToVec(voxelColor.a);",
//     "    highp float surfaceIntersectionOffset = dot(surfaceVector, rayDirection);",
